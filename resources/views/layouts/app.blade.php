...
<body>
        ...
        @auth
            <div class="sidebar" id="sidebar">
                <div class="sidebar-header">
                    ...
                    <div class="mt-1">
                        <span class="badge"
                            style="background-color: rgba(255,255,255,0.15); color: rgba(255,255,255,0.7); font-size: 0.7rem; font-weight: 400; letter-spacing: 0.05em;">
                ...
                <ul class="sidebar-menu">
                        ...
                        @if(auth()->user()->isCoordinator() || auth()->user()->isSubcoordinator() || auth()->user()->isSecretary() || auth()->user()->isSubsecretary() || auth()->user()->isOrganizer() || auth()->user()->isSuborganizer())
                            <li>
                                <a href="{{ route('grupos.index') }}"
                                    class="nav-link {{ request()->routeIs('grupos.*') ? 'active' : '' }}">
                        ...
                        @if(auth()->user()->isCoordinator() || auth()->user()->isSubcoordinator() || auth()->user()->isOrganizer() || auth()->user()->isSuborganizer())
                            <li>
                                <a href="{{ route('programas.index') }}"
                                    class="nav-link {{ request()->routeIs('programas.*') ? 'active' : '' }}">
                    ...
                    @can('can.access.admin.menu')
                        @if(auth()->user()->isSupervisor())
                            <li class="nav-category accordion-toggle collapsed" data-bs-toggle="collapse"
                                data-bs-target="#config-supervisor-menu" aria-expanded="false">
                            ...
                            <div class="collapse accordion-content" id="config-supervisor-menu">
                                ...
                                <li>
                                    <a href="{{ route('nombramiento.index') }}"
                                        class="nav-link {{ request()->routeIs('nombramiento.*') ? 'active' : '' }}">
                                ...
                                <li>
                                    <a href="{{ route('congregaciones.index') }}"
                                        class="nav-link {{ request()->routeIs('congregaciones.*') ? 'active' : '' }}">
                                ...
                                <li>
                                    <a href="{{ route('estados-espirituales.index') }}"
                                        class="nav-link {{ request()->routeIs('estados-espirituales.*') ? 'active' : '' }}">
                                        <i class="fas fa-heart"></i>Estados Espirituales
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ route('canciones.index') }}"
                                        class="nav-link {{ request()->routeIs('canciones.*') ? 'active' : '' }}">
                    ...
                    @can('admin')
                        <li class="nav-category accordion-toggle collapsed" data-bs-toggle="collapse"
                            data-bs-target="#config-admin-menu" aria-expanded="false">
                            <i class="fas fa-cogs me-2"></i>CONFIGURACIÓN
                            <i class="fas fa-chevron-down accordion-icon"></i>
                        </li>
                        <div class="collapse accordion-content" id="config-admin-menu">
                            ...
                            <li>
                                <a href="{{ route('secciones-reunion.index') }}"
                                    class="nav-link {{ request()->routeIs('secciones-reunion.*') ? 'active' : '' }}">
                                    <i class="fas fa-list-alt"></i>Secciones Reunión
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('partes-seccion.index') }}"
                                    class="nav-link {{ request()->routeIs('partes-seccion.*') ? 'active' : '' }}">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="mis_datos_name" name="name"
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="email" class="form-control" id="mis_datos_email" name="email"
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <p class="text-muted small">Deje los campos en blanco si no desea cambiar la contraseña
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="mis_datos_password_confirmation" class="form-label">Confirmar
                                        Contraseña</label>
                                    <input type="password" class="form-control" id="mis_datos_password_confirmation"
    ...
    <div class="modal fade" id="miCongregacionModal" tabindex="-1" aria-labelledby="miCongregacionModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="congregacion_nombre" name="nombre"
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control" id="congregacion_codigo" name="codigo"
                                                value="{{ $congregacion->codigo }}" readonly>
                                            <button type="button" class="btn btn-outline-secondary" id="btn_refresh_codigo"
                                                title="Generar código aleatorio">
                                                <i class="fas fa-sync-alt"></i>
                                            </button>
                                            <button type="button" class="btn btn-outline-primary" id="btn_copy_informe_link"
                                                title="Copiar enlace del informe">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="congregacion_telefono" name="telefono"
                                            value="{{ $congregacion->telefono }}">
                                        <div class="invalid-feedback"></div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="congregacion_persona_contacto" class="form-label">Persona de
                                            Contacto</label>
                                        <input type="text" class="form-control" id="congregacion_persona_contacto"
                                            name="persona_contacto" value="{{ $congregacion->persona_contacto }}">
                                        <div class="invalid-feedback"></div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" id="congregacion_direccion" name="direccion"
                                            rows="3">{{ $congregacion->direccion }}</textarea>
                                        <div class="invalid-feedback"></div>
                                    </div>
                                </div>
                            </div>
    ...
    <div class="modal fade" id="confirmCodigoModal" tabindex="-1" aria-labelledby="confirmCodigoModalLabel"
        aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p class="text-warning"><small>Esta acción generará un nuevo código único y se actualizará en la
                            base de datos.</small></p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancelar</button>
