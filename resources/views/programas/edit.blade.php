...
@section('content')
    @if($currentUser->isCoordinator() || $currentUser->isOrganizer())
                    ...
                    <div class="card">
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-md-6">
                                    <div class="d-flex justify-content-end gap-2">
                                        <!-- Botón Ver -->
                                        <a href="{{ route('programas.show', $programa->id) }}" class="btn btn-info"
                                            title="Ver programa">
                        ...
                        <div class="card-body">
                            ...
                            <form id="editProgramaForm">
                                ...
                                <input type="hidden" id="fecha_programa_hidden"
                                    value="{{ $programa->fecha ? $programa->fecha->format('Y-m-d') : '' }}">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                <input type="text" class="form-control" id="orador_inicial_display"
                                                    name="orador_inicial_display"
                                                    value="{{ $programa->oradorInicial ? $programa->oradorInicial->name : '' }}"
                                                    disabled>
                                                <button type="button" class="btn btn-outline-primary"
                                                    id="btn-buscar-orador-inicial" title="Buscar Orador Inicial"
                                                    onclick="buscarOradorInicial()">
                                                    <i class="fas fa-search"></i>
                                                </button>
                                            </div>
                                            <input type="hidden" id="orador_inicial" name="orador_inicial"
                                                value="{{ $programa->orador_inicial }}">
                                            <div class="invalid-feedback"></div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                <input type="text" class="form-control" id="cancion_pre_display"
                                                    name="cancion_pre_display"
                                                    value="{{ $programa->cancionPre ? ($programa->cancionPre->numero ? $programa->cancionPre->numero . ' - ' : '') . $programa->cancionPre->nombre : '' }}"
                                                    disabled>
                                                <button type="button" class="btn btn-outline-primary"
                                                    id="btn-buscar-cancion-inicial" title="Buscar Canción Inicial"
                                                    onclick="buscarCancionInicial()">
                                                    <i class="fas fa-search"></i>
                                                </button>
                                            </div>
                                            <input type="hidden" id="cancion_pre" name="cancion_pre"
                                                value="{{ $programa->cancion_pre }}">
                                            <div class="invalid-feedback"></div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                <input type="text" class="form-control" id="presidencia_display"
                                                    name="presidencia_display"
                                                    value="{{ $programa->presidenciaUsuario ? $programa->presidenciaUsuario->name : '' }}"
                                                    disabled>
                                                <button type="button" class="btn btn-outline-primary"
                                                    id="btn-buscar-presidencia" title="Buscar Presidentes"
                                                    onclick="buscarPresidencia()">
                                                    <i class="fas fa-search"></i>
                                                </button>
                                            </div>
                                            <input type="hidden" id="presidencia" name="presidencia"
                                                value="{{ $programa->presidencia }}">
                                            <div class="invalid-feedback"></div>
                                        </div>
                                    </div>
                                </div>
                                                    ...
                                                    <div class="d-flex justify-content-between align-items-center mb-0">
                                                        ...
                                                        <div class="d-flex justify-content-end">
                                                            <button type="button" class="btn btn-primary btn-sm"
                                                                data-bs-toggle="modal" data-bs-target="#parteProgramaModal"
                                                                onclick="openCreateParteModal()">
                                    ...
                                    <div class="col-12">
                                        <div class="card mb-4">
                                                ...
                                                <div class="row align-items-center">
                                                    <div class="d-flex justify-content-between align-items-center mb-1">
                                                        <h6 class="mb-0" style="margin-top:10px;">
                                                            <i class="fas fa-graduation-cap me-2"></i>ESCUELA SEAMOS MEJORES
                                                            MAESTROS
                                                        </h6>
                                                        <div class="d-flex justify-content-end">
                                                            <button type="button" class="btn btn-primary btn-sm"
                                                                data-bs-toggle="modal"
                                                                data-bs-target="#parteProgramaSegundaSeccionModal"
                                                                onclick="openCreateParteSegundaSeccionModal()">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="mb-4">
                                                    <div class="table-responsive">
                                                        <table id="partesSegundaSeccionTable"
                                            ...
                                            <div class="card-header" style="background-color: #FCBBBF;">
                                                <div class="row align-items-center">
                                                    <div class="d-flex justify-content-between align-items-center mb-0">
                                                        ...
                                                        <div class="d-flex justify-content-end">
                                                            <button type="button" class="btn btn-primary btn-sm"
                                                                data-bs-toggle="modal" data-bs-target="#parteProgramaNVModal"
                                                                onclick="openCreateParteNVModal()">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                <input type="text" class="form-control" id="cancion_en_display"
                                                    name="cancion_en_display"
                                                    value="{{ $programa->cancionEn ? ($programa->cancionEn->numero ? $programa->cancionEn->numero . ' - ' : '') . $programa->cancionEn->nombre : '' }}"
                                                    disabled>
                                                <button type="button" class="btn btn-outline-primary"
                                                    id="btn-buscar-cancion-intermedia" title="Buscar Canción Intermedia"
                                                    onclick="buscarCancionIntermedia()">
                                                    <i class="fas fa-search"></i>
                                                </button>
                                            </div>
                                            <input type="hidden" id="cancion_en" name="cancion_en"
                                                value="{{ $programa->cancion_en }}">
                                            <div class="invalid-feedback"></div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                <input type="text" class="form-control" id="cancion_post_display"
                                                    name="cancion_post_display"
                                                    value="{{ $programa->cancionPost ? ($programa->cancionPost->numero ? $programa->cancionPost->numero . ' - ' : '') . $programa->cancionPost->nombre : '' }}"
                                                    disabled>
                                                <button type="button" class="btn btn-outline-primary"
                                                    id="btn-buscar-cancion-final" title="Buscar Canción Final"
                                                    onclick="buscarCancionFinal()">
                                                    <i class="fas fa-search"></i>
                                                </button>
                                            </div>
                                            <input type="hidden" id="cancion_post" name="cancion_post"
                                                value="{{ $programa->cancion_post }}">
                                            <div class="invalid-feedback"></div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                <input type="text" class="form-control" id="orador_final_display"
                                                    name="orador_final_display"
                                                    value="{{ $programa->oradorFinal ? $programa->oradorFinal->name : '' }}"
                                                    disabled>
                                                <button type="button" class="btn btn-outline-primary"
                                                    id="btn-buscar-orador-final" title="Buscar Orador Final"
                                                    onclick="buscarOradorFinal()">
                                                    <i class="fas fa-search"></i>
                                                </button>
                                            </div>
                                            <input type="hidden" id="orador_final" name="orador_final"
                                                value="{{ $programa->orador_final }}">
                                            <div class="invalid-feedback"></div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
        ...
        @if(isset($programaAnterior) && $programaAnterior)
            <a href="{{ route('programas.edit', $programaAnterior->id) }}" class="btn-nav-flotante btn-nav-anterior"
        ...
        @if(isset($programaPosterior) && $programaPosterior)
            <a href="{{ route('programas.edit', $programaPosterior->id) }}" class="btn-nav-flotante btn-nav-posterior"
                title="Programa siguiente">
                <span class="btn-nav-label">Siguiente</span>
                <i class="fas fa-chevron-right"></i>
            </a>
        @else
            <button type="button" class="btn-nav-flotante btn-nav-posterior disabled" disabled title="No hay programa siguiente">
                <span class="btn-nav-label">Siguiente</span>
                <i class="fas fa-chevron-right"></i>
            </button>
        @endif
        ...
        <div class="modal fade" id="parteProgramaModal" tabindex="-1" aria-labelledby="parteProgramaModalLabel"
            aria-hidden="true">
                    ...
                    <form id="parteProgramaForm">
                        <div class="modal-body">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="parte_id" class="form-label">Asignación <span
                                                class="text-danger">*</span></label>
                                        <select class="form-select" id="parte_id" name="parte_id" required>
                                            <option value="">Cargando...</option>
                                        </select>
                                        <input type="text" class="form-control" id="parte_display" style="display: none;"
                                            disabled>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="tiempo_parte" class="form-label">Tiempo (minutos) <span
                                                class="text-danger">*</span></label>
                                        <input type="number" class="form-control" id="tiempo_parte" name="tiempo" min="1"
                                            max="60" required>
                                        <div class="invalid-feedback"></div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="encargado_id" class="form-label">Encargado <span
                                                class="text-danger">*</span></label>
                                        <div class="input-group">
                                            <input type="text" class="form-control" id="encargado_display"
                                                name="encargado_display" placeholder="Seleccionar encargado..." disabled>
                                            ...
                                            <button type="button" class="btn btn-outline-success" id="btn-agregar-reemplazado"
                                                title="Agregar como Encargado Reemplazado"
                                                onclick="agregarEncargadoReemplazado()" disabled>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="encargado_reemplazado_display" class="form-label">Encargado
                                            Reemplazado</label>
                                        <div class="input-group">
                                            <input type="text" class="form-control" id="encargado_reemplazado_display"
                                                name="encargado_reemplazado_display" placeholder="Sin Encargado reemplazado..."
                                                disabled>
                                            <button type="button" class="btn btn-outline-danger" id="btn-eliminar-reemplazado"
                                                title="Eliminar Encargado Reemplazado" onclick="eliminarEncargadoReemplazado()"
                                                disabled>
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" class="btn btn-info" id="verAsignacionBtn" style="display: none;"
                                onclick="verAsignacionDesdeParteProgramaModal()">
        ...
        <div class="modal fade" id="parteProgramaSegundaSeccionModal" tabindex="-1"
            aria-labelledby="parteProgramaSegundaSeccionModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="parteProgramaSegundaSeccionModalLabel">Nueva Asignación Seamos Mejores
                            Maestros</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <form id="parteProgramaSegundaSeccionForm">
                        <div class="modal-body">
                            ...
                            <input type="hidden" id="programa_id_segunda_seccion" name="programa_id"
                                value="{{ $programa->id }}">

                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="sala_id_segunda_seccion" class="form-label">Sala <span
                                                class="text-danger">*</span></label>
                                        <select class="form-select" id="sala_id_segunda_seccion" name="sala_id" required>
                                            <option value="">Seleccionar...</option>
                                            @foreach($salas as $sala)
                                                <option value="{{ $sala->id }}" {{ $sala->id == 1 ? 'selected' : '' }}>
                                                    {{ $sala->abreviacion }} - {{ $sala->nombre }}
                                                </option>
                                            @endforeach
                                        </select>
                                        <div class="invalid-feedback"></div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="parte_id_segunda_seccion" class="form-label">Asignación <span
                                                class="text-danger">*</span></label>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="encargado_display_segunda_seccion" class="form-label">Estudiante <span
                                                class="text-danger">*</span></label>
                                        <div class="input-group">
                                            <input type="text" class="form-control" id="encargado_display_segunda_seccion"
                                                name="encargado_display" placeholder="Seleccionar una parte primero..."
                                                disabled>
                                            <button type="button" class="btn btn-outline-primary"
                                                id="btn-buscar-encargado-segunda" onclick="buscarEncargadoSegundaSeccion()"
                                                title="Buscar Estudiante" disabled>
                                                <i class="fas fa-search"></i>
                                            </button>

                                            <button type="button" class="btn btn-outline-success"
                                                id="btn-agregar-encargado-reemplazado-segunda"
                                                onclick="agregarEncargadoReemplazado()"
                                                title="Agregar Estudiante como Reemplazado" disabled style="display: none;">
                                                <i class="fas fa-user-plus"></i>
                                            </button>
                                            <button type="button" class="btn btn-outline-success"
                                                id="btn-encargado-reemplazado-segunda" onclick="manejarEncargadoReemplazado()"
                                                title="Estudiante reemplazado" disabled>
                                                <i class="fas fa-user-plus"></i>
                                            </button>
                                        </div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control" id="ayudante_display_segunda_seccion"
                                                name="ayudante_display" placeholder="Seleccionar..." disabled>
                                            <button type="button" class="btn btn-outline-primary"
                                                id="btn-buscar-ayudante-segunda" onclick="buscarAyudanteSegundaSeccion()"
                                                title="Buscar Ayudante">
                                                <i class="fas fa-search"></i>
                                            </button>

                                            <button type="button" class="btn btn-outline-success"
                                                id="btn-agregar-ayudante-reemplazado-segunda"
                                                onclick="agregarAyudanteReemplazado()" title="Agregar Ayudante como Reemplazado"
                                                disabled style="display: none;">
                                                <i class="fas fa-user-plus"></i>
                                            </button>
                                            <button type="button" class="btn btn-outline-success"
                                                id="btn-ayudante-reemplazado-segunda" onclick="manejarAyudanteReemplazado()"
                                                title="Ayudante reemplazado" disabled>
                                                <i class="fas fa-user-plus"></i>
                                            </button>
                                        </div>
                            ...
                            <div class="row" id="campos-reemplazados-segunda-seccion" style="display: none;">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="encargado_reemplazado_segunda_seccion" class="form-label">Estudiante
                                            Reemplazado</label>
                                        <div class="input-group">
                                            <input type="text" class="form-control" id="encargado_reemplazado_segunda_seccion"
                                                readonly>
                                            <input type="hidden" id="encargado_reemplazado_id_segunda_seccion"
                                                name="encargado_reemplazado_id">
                                            <button type="button" class="btn btn-outline-danger"
                                                onclick="clearEncargadoReemplazado()" title="Eliminar estudiante reemplazado">
                                                <i class="fas fa-user-times"></i>
                                            </button>
                                        </div>
                                        <div class="invalid-feedback"></div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="ayudante_reemplazado_segunda_seccion" class="form-label">Ayudante
                                            Reemplazado</label>
                                        <div class="input-group">
                                            <input type="text" class="form-control" id="ayudante_reemplazado_segunda_seccion"
                                                readonly>
                                            <input type="hidden" id="ayudante_reemplazado_id_segunda_seccion"
                                                name="ayudante_reemplazado_id">
                                            <button type="button" class="btn btn-outline-danger"
                                                onclick="clearAyudanteReemplazado()" title="Eliminar ayudante reemplazado">
                                                <i class="fas fa-user-times"></i>
                                            </button>
                                        </div>
                                        <div class="invalid-feedback"></div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="tiempo_segunda_seccion" class="form-label">Tiempo (minutos) <span
                                                class="text-danger">*</span></label>
                                        <input type="number" class="form-control" id="tiempo_segunda_seccion" name="tiempo"
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="leccion_segunda_seccion" name="leccion"
                                            maxlength="500">
                                        <div class="invalid-feedback"></div>
                                    </div>
                                </div>
        ...
        <div class="modal fade" id="verAsignacionModal" tabindex="-1" aria-labelledby="verAsignacionModalLabel"
            aria-hidden="true">
        ...
        <div class="modal fade" id="parteProgramaTerceraSeccionModal" tabindex="-1"
            aria-labelledby="parteProgramaTerceraSeccionModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="parteProgramaTerceraSeccionModalLabel">Nueva Asignación de Seamos Mejores
                            Maestros</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <form id="parteProgramaTerceraSeccionForm">
                        <div class="modal-body">
                            ...
                            <input type="hidden" id="programa_id_tercera_seccion" name="programa_id"
                                value="{{ $programa->id }}">

                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="parte_id_tercera_seccion" class="form-label">Asignación <span
                                                class="text-danger">*</span></label>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="tiempo_tercera_seccion" class="form-label">Tiempo (minutos) <span
                                                class="text-danger">*</span></label>
                                        <input type="number" class="form-control" id="tiempo_tercera_seccion" name="tiempo"
                                            min="1" max="60" required>
                                        <div class="invalid-feedback"></div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="encargado_id_tercera_seccion" class="form-label">Estudiante <span
                                                class="text-danger">*</span></label>
                                        <div class="d-flex">
                                            <button type="button" class="btn btn-outline-primary me-2"
                                                id="btn-agregar-encargado-reemplazado-tercera"
                                                onclick="agregarEncargadoReemplazadoTercera()"
                                                title="Agregar como encargado reemplazado" style="display: none;">
                                                <i class="fas fa-user-plus"></i>
                                            </button>
                                            <select class="form-select select2" id="encargado_id_tercera_seccion"
                                                name="encargado_id" required style="flex: 1;">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <div class="d-flex">
                                            <button type="button" class="btn btn-outline-primary me-2"
                                                id="btn-agregar-ayudante-reemplazado-tercera"
                                                onclick="agregarAyudanteReemplazadoTercera()"
                                                title="Agregar como ayudante reemplazado" style="display: none;">
                                                <i class="fas fa-user-plus"></i>
                                            </button>
                                            <select class="form-select select2" id="ayudante_id_tercera_seccion"
                                                name="ayudante_id" style="flex: 1;">
                                                <option value="">Seleccionar...</option>
                                            </select>
                                        </div>
                                        <div class="invalid-feedback"></div>
                            ...
                            <div class="row" id="campos-reemplazados-tercera-seccion">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="encargado_reemplazado_tercera_seccion" class="form-label">Encargado
                                            Reemplazado</label>
                                        <div class="input-group">
                                            <button type="button" class="btn btn-outline-danger"
                                                onclick="clearEncargadoReemplazadoTercera()"
                                                title="Eliminar encargado reemplazado">
                                                <i class="fas fa-user-times"></i>
                                            </button>
                                            <input type="text" class="form-control" id="encargado_reemplazado_tercera_seccion"
                                                readonly>
                                            <input type="hidden" id="encargado_reemplazado_id_tercera_seccion"
                                                name="encargado_reemplazado_id">
                                        </div>
                                        <div class="invalid-feedback"></div>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="ayudante_reemplazado_tercera_seccion" class="form-label">Ayudante
                                            Reemplazado</label>
                                        <div class="input-group">
                                            <button type="button" class="btn btn-outline-danger"
                                                onclick="clearAyudanteReemplazadoTercera()"
                                                title="Eliminar ayudante reemplazado">
                                                <i class="fas fa-user-times"></i>
                                            </button>
                                            <input type="text" class="form-control" id="ayudante_reemplazado_tercera_seccion"
                                                readonly>
                                            <input type="hidden" id="ayudante_reemplazado_id_tercera_seccion"
                                                name="ayudante_reemplazado_id">
                                        </div>
                                        <div class="invalid-feedback"></div>
                                    </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="leccion_tercera_seccion" name="leccion"
                                    maxlength="500">
                                <div class="invalid-feedback"></div>
                            </div>
                        </div>
        ...
        <div class="modal fade" id="parteProgramaNVModal" tabindex="-1" aria-labelledby="parteProgramaNVModalLabel"
            aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <form id="parteProgramaNVForm">
                        <div class="modal-body">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="parte_id_nv" class="form-label">Asignación <span
                                                class="text-danger">*</span></label>
                                        <select class="form-select" id="parte_id_nv" name="parte_id" required>
                                            <option value="">Cargando...</option>
                                        </select>
                                        <input type="text" class="form-control" id="parte_display_nv" style="display: none;"
                                            disabled>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="tiempo_parte_nv" class="form-label">Tiempo (minutos) <span
                                                class="text-danger">*</span></label>
                                        <input type="number" class="form-control" id="tiempo_parte_nv" name="tiempo" min="1"
                                            max="60" required>
                                        <div class="invalid-feedback"></div>
                                    </div>
                                </div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="tema_parte_nv" name="tema" rows="2"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="encargado_id_nv" class="form-label">Encargado <span
                                                class="text-danger">*</span></label>
                                        <div class="input-group">
                                            <input type="text" class="form-control" id="encargado_display_nv"
                                                name="encargado_display" placeholder="Seleccionar encargado..." disabled>
                                            ...
                                            <button type="button" class="btn btn-outline-success"
                                                id="btn-agregar-reemplazado-nv" title="Agregar como Encargado Reemplazado"
                                                onclick="agregarEncargadoReemplazadoNV()" disabled>
                                                <i class="fas fa-user-plus"></i>
                                            </button>
                                        </div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="encargado_reemplazado_display_nv" class="form-label">Encargado
                                            Reemplazado</label>
                                        <div class="input-group">
                                            <input type="text" class="form-control" id="encargado_reemplazado_display_nv"
                                                name="encargado_reemplazado_display" placeholder="Sin encargado reemplazado..."
                                                disabled>
                                            <button type="button" class="btn btn-outline-danger"
                                                id="btn-eliminar-reemplazado-nv" title="Eliminar Encargado Reemplazado"
                                                onclick="eliminarEncargadoReemplazadoNV()" disabled>
                                                <i class="fas fa-user-times"></i>
                                            </button>
                                        </div>
        ...
        <div class="modal fade" id="buscarOradorInicialModal" tabindex="-1" aria-labelledby="buscarOradorInicialModalLabel"
            aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            ...
                            <small class="form-text text-muted">Usuarios con asignación de oración, ordenados por fecha más
                                reciente de participación</small>
                        </div>
                        <div class="mb-3">
                            <label for="select_historial_orador" class="form-label">Historial de Participaciones como
                                Orador</label>
        ...
        <div class="modal fade" id="buscarOradorFinalModal" tabindex="-1" aria-labelledby="buscarOradorFinalModalLabel"
            aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            <label for="select_historial_orador_final" class="form-label">Historial de Participaciones como
                                Orador</label>
        ...
        <div class="modal fade" id="buscarPresidenciaModal" tabindex="-1" aria-labelledby="buscarPresidenciaModalLabel"
            aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            ...
                            <small class="form-text text-muted">Usuarios con asignación de presidencia, ordenados por fecha más
                                reciente de participación</small>
                        </div>
                        <div class="mb-3">
                            <label for="select_historial_presidencia" class="form-label">Historial de Participaciones como
                                Presidente</label>
        ...
        <div class="modal fade" id="buscarCancionInicialModal" tabindex="-1" aria-labelledby="buscarCancionInicialModalLabel"
            aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
        ...
        <div class="modal fade" id="buscarCancionIntermediaModal" tabindex="-1"
            aria-labelledby="buscarCancionIntermediaModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
        ...
        <div class="modal fade" id="buscarCancionFinalModal" tabindex="-1" aria-labelledby="buscarCancionFinalModalLabel"
            aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
        ...
        <div class="modal fade" id="buscarEncargadoParteModal" tabindex="-1" aria-labelledby="buscarEncargadoParteModalLabel"
            aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            ...
                            <small class="form-text text-muted">Usuarios con participaciones en la parte seleccionada, ordenados
                                por fecha más reciente</small>
                        </div>
                        <div class="mb-3">
                            ...
                            <small class="form-text text-muted">Participaciones como encargado en la parte actual, ordenadas
                                desde la más reciente</small>
                        </div>
                    </div>
                    <br><br><br><br><br><br>
                    <div class="modal-footer">
        ...
        <div class="modal fade" id="buscarEncargadoParteNVModal" tabindex="-1"
            aria-labelledby="buscarEncargadoParteNVModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
        ...
        <div class="modal fade" id="buscarEncargadoSegundaSeccionModal" tabindex="-1"
            aria-labelledby="buscarEncargadoSegundaSeccionModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        <div class="mb-3" id="filtro_sexo_encargado_segunda_container">
                            ...
                            <div class="d-flex gap-3">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="filtro_sexo_encargado_segunda"
                                        id="filtro_hombres_encargado_segunda" value="1">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="filtro_sexo_encargado_segunda"
                                        id="filtro_mujeres_encargado_segunda" value="2" checked>
                        ...
                        <div class="mb-3">
                            ...
                            <small class="form-text text-muted">Estudiantes o ayudante que han participado en partes_programa,
                                ordenados por fecha más reciente.</small>
                        </div>

                        <div class="mb-3">
                            <label for="select_historial_encargado_segunda_seccion" class="form-label">Historial del Estudiante
                                (Escribir "R-" para ver reemplazos realizados)</label>
                            <select class="form-select" id="select_historial_encargado_segunda_seccion" style="width: 100%;"
                                disabled>
                                <option value="">Seleccionar un estudiante primero...</option>
                            </select>
                            <small class="form-text text-muted">Historial de participaciones del estudiante seleccionado en la
                                segunda sección, ordenadas desde la más reciente.</small>
                        </div>
                    </div>
                    <br><br><br><br><br><br>
                    <div class="modal-footer">
        ...
        <div class="modal fade" id="buscarAyudanteSegundaSeccionModal" tabindex="-1"
            aria-labelledby="buscarAyudanteSegundaSeccionModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        <div class="mb-3" id="filtro_sexo_ayudante_segunda_container" style="display: none;">
                            ...
                            <div class="d-flex gap-3">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="filtro_sexo_ayudante_segunda"
                                        id="filtro_hombres_ayudante_segunda" value="1">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="filtro_sexo_ayudante_segunda"
                                        id="filtro_mujeres_ayudante_segunda" value="2">
                        ...
                        <div class="mb-3">
                            ...
                            <small class="form-text text-muted">Ayudantes que han participado en partes_programa, ordenados por
                                fecha más reciente.</small>
                        </div>

                        <div class="mb-3">
                            <label for="select_historial_ayudante_segunda_seccion" class="form-label">Historial del Ayudante
                                (Escribir "R-" para ver reemplazos realizados)</label>
                            <select class="form-select" id="select_historial_ayudante_segunda_seccion" style="width: 100%;"
                                disabled>
                                <option value="">Seleccionar un ayudante primero...</option>
                            </select>
                            <small class="form-text text-muted">Historial de participaciones del ayudante seleccionado en la
                                segunda sección, ordenadas desde la más reciente.</small>
                        </div>
                    </div>
                    <br><br><br><br><br><br>
        ...
        <div class="modal fade" id="historialEncargadoParteModal" tabindex="-1"
            aria-labelledby="historialEncargadoParteModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
        ...
        <div class="modal fade" id="confirmarAgregarReemplazadoModal" tabindex="-1"
            aria-labelledby="confirmarAgregarReemplazadoModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
        ...
        <div class="modal fade" id="confirmarEliminarReemplazadoModal" tabindex="-1"
            aria-labelledby="confirmarEliminarReemplazadoModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
