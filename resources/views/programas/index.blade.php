                                ...
                                <div class="col-md-5">
                                    <div class="d-flex justify-content-end align-items-center gap-2 flex-wrap">
                                        ...
                                        <button class="btn btn-outline-secondary" type="button" data-bs-toggle="collapse"
                                            data-bs-target="#generarDocumentosCollapse" aria-expanded="false"
                                            aria-controls="generarDocumentosCollapse">
                                        ...
                                        @if($currentUser->isCoordinator() || $currentUser->isOrganizer())
                                            <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                                data-bs-target="#addProgramaModal">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="dropdown">
                                                        <button class="btn btn-outline-secondary dropdown-toggle w-100"
                                                            type="button" id="mesDropdownBtn" data-bs-toggle="dropdown"
                                                            aria-expanded="false" disabled>
                                                            Seleccionar meses
                                                        </button>
                                                        <ul class="dropdown-menu p-3" aria-labelledby="mesDropdownBtn"
                                                            id="mesDropdownMenu" style="min-width: 200px;">
                                                            <li>
                                                            ...
                                                            <li class="px-2">
                                                                <button type="button"
                                                                    ...
                                                                    id="seleccionarTodosMeses">Seleccionar Todos</button>
                                                            </li>
                                                            <li class="px-2 mt-2">
                                                                <button type="button"
                                                                    class="btn btn-sm btn-outline-secondary w-100"
                                                                    id="limpiarMeses">Limpiar Selección</button>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="btn-group" role="group">
                                                        ...
                                                        @if($currentUser->isCoordinator() || $currentUser->isOrganizer())
                                                            ...
                                                            <button type="button" class="btn btn-sm btn-danger delete-programa"
                                                                data-id="{{ $programa->id }}" data-bs-toggle="modal"
                                                                data-bs-target="#confirmDeleteModal" data-bs-toggle="tooltip"
                                        ...
                                        <select class="form-select" id="add_cancion_pre" name="cancion_pre">
                                            ...
                                            @foreach($canciones as $cancion)
                                                <option value="{{ $cancion->id }}">
                                                    {{ $cancion->numero ? $cancion->numero . ' - ' : '' }}{{ $cancion->nombre }}
                                                </option>
                                            @endforeach
                                        </select>
                                        <div class="invalid-feedback"></div>
