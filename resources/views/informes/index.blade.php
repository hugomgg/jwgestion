...
@section('content')
                                            ...
                                            <td>
                                                <div class="btn-group" role="group">
                                                    <button type="button" class="btn btn-sm btn-info view-informe"
                                                        data-informe-id="{{ $informe->id }}" data-bs-toggle="tooltip"
                                                        title="Ver informe">
                                                    ...
                                                    @if(Auth::user()->canModify() && !Auth::user()->isSubsecretary() && !Auth::user()->isSuborganizer())
                                                        ...
                                                        <button type="button" class="btn btn-sm btn-danger delete-informe"
                                                            ...
                                                            data-bs-toggle="tooltip" title="Eliminar informe">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="cantidad_estudios"
                                        name="cantidad_estudios" min="0" value="0">
                                    <div class="invalid-feedback"></div>
                                </div>
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="edit_cantidad_estudios"
                                        name="cantidad_estudios" min="0">
                                    <div class="invalid-feedback"></div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="edit_horas" name="horas" min="0"
                                        step="0.5">
                                    <div class="invalid-feedback"></div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" id="edit_nota" name="nota" rows="3"
                                        maxlength="1000"></textarea>
                                    <div class="invalid-feedback"></div>
                                    <small class="form-text text-muted">Máximo 1000 caracteres</small>
                                </div>
    ...
    <div class="modal fade" id="deleteInformeModal" tabindex="-1" aria-labelledby="deleteInformeModalLabel"
        aria-hidden="true">
    ...
    <div class="modal fade" id="informeCongregacionModal" tabindex="-1" aria-labelledby="informeCongregacionModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
    ...
    <div class="modal fade" id="registroPublicadorModal" tabindex="-1" aria-labelledby="registroPublicadorModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <div id="registroPublicadorInfo" class="d-none mb-3">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <p class="mb-1"><strong>Fecha de nacimiento:</strong> <span
                                                id="info_fecha_nacimiento">-</span></p>
                                    </div>
                                    <div class="col-md-6">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <p class="mb-1"><strong>Fecha de bautismo:</strong> <span
                                                id="info_fecha_bautismo">-</span></p>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-check form-check-inline">
                                ...
                                <div class="row mt-2">
                                    <div class="col-12">
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="checkbox" id="info_precursor_regular"
                                                disabled>
                                            <label class="form-check-label" for="info_precursor_regular">Precursor
                                                regular</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="checkbox" id="info_precursor_especial"
                                                disabled>
                                            <label class="form-check-label" for="info_precursor_especial">Precursor
                                                especial</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="checkbox" id="info_misionero" disabled>
                                            <label class="form-check-label" for="info_misionero">Misionero que sirve en el
                                                campo</label>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div id="registroPublicadorContainer" class="d-none">
                        <ul class="nav nav-tabs" id="registroPublicadorTabs" role="tablist">
                            <li class="nav-item" role="presentation">
                                <button class="nav-link active" id="tab-anio-actual" data-bs-toggle="tab"
                                    data-bs-target="#tabpanel-anio-actual" type="button" role="tab"
                                    aria-controls="tabpanel-anio-actual" aria-selected="true">
                                    <span id="tab-anio-actual-text">Año Actual</span>
                                </button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="tab-anio-anterior" data-bs-toggle="tab"
                                    data-bs-target="#tabpanel-anio-anterior" type="button" role="tab"
                                    aria-controls="tabpanel-anio-anterior" aria-selected="false">
                        ...
                        <div class="tab-content" id="registroPublicadorTabsContent">
                            <!-- Tab Año Actual -->
                            <div class="tab-pane fade show active" id="tabpanel-anio-actual" role="tabpanel"
                                aria-labelledby="tab-anio-actual">
                                <div class="table-responsive mt-3">
                                    <table class="table table-bordered table-sm" id="registroPublicadorTable">
                                        <thead class="table-dark">
                                            <tr>
                                                <th style="width: 100px;">Año de servicio</th>
                                                <th style="width: 80px;" class="text-center">Participación en el ministerio
                                                </th>
                                                <th style="width: 80px;" class="text-center">Cursos bíblicos</th>
                                                <th style="width: 80px;" class="text-center">Precursor auxiliar</th>
                                                <th style="width: 100px;" class="text-center">Horas<br><small>(Si es
                                                        precursor o misionero que sirve en el campo)</small></th>
                                                <th>Notas</th>
                                            </tr>
                                        </thead>
                            ...
                            <!-- Tab Año Anterior -->
                            <div class="tab-pane fade" id="tabpanel-anio-anterior" role="tabpanel"
                                aria-labelledby="tab-anio-anterior">
                                <div class="table-responsive mt-3">
